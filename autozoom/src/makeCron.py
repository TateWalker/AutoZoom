...
def main(classes):
    ...
    for i in classes.keys():
        ...
        if end_time[0] < start_time[0]:
            class_length = (e_t-s_t)// timedelta(minutes=1)+1440
        else:
        ...
        # print(cwd)
        # print(cwd)
        cron_instructions = 'cd {}/scripts && ./realZoom.sh {} {} >> {}/data/cron_instructions.txt 2>&1'.format(cwd,url,class_length,cwd)
